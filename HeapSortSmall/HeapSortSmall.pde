...
void draw() {
  ...
  //"while"
   if (part > 0 && done &&!swapping){
    ...
    System.out.println("swapping" + "0 and part: " + part);
    swap(0, part);
    part -= 1;
    index = 0;
      }
